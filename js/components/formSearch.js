  ...
  template() {
    ...
    <div class="container-search container">
      <form class="d-flex" role="search" id="form-search">
        ...
        <select class="form-select form-control me-2" id="ubication" name="ubication"><option selected disabled value="">UBICACIONES</option></select>
        <select class="form-select form-control me-2" id="category" name="category"><option selected disabled value="">CATEGORIAS</option></select>
        <select class="form-select form-control me-2" id="commission" name="commission"><option selected disabled value="">COMISION</option></select>
